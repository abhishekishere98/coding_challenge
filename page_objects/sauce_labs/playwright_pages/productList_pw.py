from page_objects.sauce_labs.playwright_pages.cartPage_pw import CartPage
...
class ProductListPage:
    ...
    def __init__(self, page):
        ...
        self._add_to_cart = page.locator("//div[text()='Sauce Labs Bike Light']/ancestor::div["
    ...
    def get_add_remove_cart_locator(self, product):
        ...
        return self.page.locator(f"//div[text()='{product}']/ancestor::div[@class='inventory_item_label']/following"
                                 f"-sibling::div//button")
